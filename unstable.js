let versionString = "Q-App Game Demo - Version: 0.2.2a - 2023/05/03<br/>KB Controls: WASD / Arrow Keys / NumPad - Mouse/Touch: On-Screen Buttons<br/>O: Item - X: Action";
...
async function updateChatMessages() {
  try {
    ...
    for (const element of res) {
      ...
      chatMessagesDiv.innerHTML += "<p><strong>" + element.senderName + "</strong>: " + messageText + ", (" + decodedString + ")</p>";
    }
...
async function loadGame() {
  ...
  try {
    ...
    chatMessagesDiv.innerHTML += "<p><strong>LOAD</strong>: " + loadGame64 + "</p>";
    loadGameString = atob(loadGame64);
    chatMessagesDiv.innerHTML += "<p><strong>LOAD</strong>: " + loadGameString + "</p>";
    let loadGameObject = JSON.parse(loadGameString);
    chatMessagesDiv.innerHTML += "<p><strong>LOAD</strong>: " + JSON.stringify(loadGameObject) + "</p>";
